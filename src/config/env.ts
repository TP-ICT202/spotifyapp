 ...
 * Pour simplifier le travail d'équipe en React Native, renseignez vos clés Supabase ici.
...
export const ENV = {
  ...
  // Bucket Supabase Storage contenant les MP3 (voir storage_setup.sql / npm run sync:music)
  STORAGE_BUCKET: 'songs-bucket',
};
